               ...
               var chart = new ApexCharts(
                ...
                if (apexdemo7.length > 0) {
                  var optionDonut = {
                    ...
                    colors: ['#006837','#2bcbba','#f7b731','#45aaf2','#e3324c'],
        ...
        var analytics7 = jQuery('#analytics7')
            ...
            if (ecommercedemo5.length > 0) {
                var options = {
                    ...
                    colors:['#006837','#fbaf54','#1beb25','#e3324c','#444444'],
                        ...
                        fill: {
                            type: 'gradient',
                                gradient: {
                                  ...
                                  opacityFrom: 1,
                                  opacityTo:1,
                                  gradientToColors: ['#006837', '#45aaf2' , '#2bcbba'],
                                  stops: [0, 90, 100]
                                }
                          },
                        colors:['#006837','#45aaf2', '#2bcbba'],
                        series: [45, 55, 80],
                        ...
                        fill: {
                            type: 'gradient',
                                gradient: {
                                  ...
                                  opacityFrom: 1,
                                  opacityTo:0.5,
                                  gradientToColors: ['#006837', '#1beb25'],
                                  stops: [0, 90, 100]
                                }
                          },
                        colors:['#006837','#1beb25'],
                        ...
                        function plotAccordingToChoices() {
                            ...
                            if (data.length > 0) {
                                $.plot("#flot-series-toggle", data, {
                                    ...
                                    colors: ["#f7b731", "#fd9644", "#32b432", "#006837", "#1beb25", "#e3324c", "#fb0792"],
                                    yaxis: {
                                        min: 0
                                    },
                                    xaxis: {
                ...
                function Sparkline() {
                    ...
                    if (sparklinedemo5.length > 0) {
                        $(sparklinedemo5).sparkline([40, 30, 20, 10], {
                            ...
                            width: '200',
                            height: '165',
                            sliceColors: ['#1beb25', '#006837', '#ffbc1d', '#25d09a']
                        });
                    }
